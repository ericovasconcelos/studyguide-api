...
exports.generateMockGranData = exports.getCloudStudyCycle = exports.syncStudyCycleWithCloud = exports.disconnectFromCloud = exports.isCloudSynced = exports.getCloudData = exports.syncToCloud = exports.saveStudyRecord = exports.getStoredRecords = exports.saveStudyRecordToLocalStorage = exports.getLocalStorageStudyRecords = void 0;
// Funções para armazenamento local
const getLocalStorageStudyRecords = () => {
    return JSON.parse(localStorage.getItem("studyRecords")) || [];
};
exports.getLocalStorageStudyRecords = getLocalStorageStudyRecords;
const saveStudyRecordToLocalStorage = (records) => {
    localStorage.setItem("studyRecords", JSON.stringify(records));
};
exports.saveStudyRecordToLocalStorage = saveStudyRecordToLocalStorage;
// Versão original para compatibilidade retroativa
const getStoredRecords = () => {
    return (0, exports.getLocalStorageStudyRecords)();
};
exports.getStoredRecords = getStoredRecords;
const saveStudyRecord = (records) => {
    (0, exports.saveStudyRecordToLocalStorage)(records);
...
exports.saveStudyRecord = saveStudyRecord;
// Funções para sincronização com cloud
const syncToCloud = (userId, cloudKey) => {
    if (!userId || !cloudKey)
        return;
    ...
    if (!returnData.dataUpdated) {
        const records = (0, exports.getLocalStorageStudyRecords)();
        window.syncToCloud(records);
...
exports.isCloudSynced = isCloudSynced;
...
exports.disconnectFromCloud = disconnectFromCloud;
// Sincronizar ciclo de estudos com a nuvem
const syncStudyCycleWithCloud = (cycle) => {
    if (!window.cloudConfig)
        return false;
    try {
...
exports.syncStudyCycleWithCloud = syncStudyCycleWithCloud;
// Recuperar ciclo de estudos da nuvem
const getCloudStudyCycle = () => {
    if (!window.cloudConfig)
        return null;
    try {
...
exports.getCloudStudyCycle = getCloudStudyCycle;
// Função para gerar dados de exemplo do Gran Cursos
const generateMockGranData = () => {
    const subjects = [
...
exports.generateMockGranData = generateMockGranData;
