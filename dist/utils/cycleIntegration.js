    ...
    try {
        ...
        if (error.response) {
            ...
            if (error.response.status === 401 || error.response.status === 403) {
                throw new Error(`Token inválido ou expirado: ${((_a = error.response.data) === null || _a === void 0 ? void 0 : _a.message) || 'Acesso negado'}`);
            }
            throw new Error(`Erro ao buscar ciclos: ${((_b = error.response.data) === null || _b === void 0 ? void 0 : _b.message) || error.message}`);
        }
...
const detectCycleRounds = async (token, cycleId) => {
    ...
    try {
        ...
        const response = await axios.get(`${API_BASE_URL}/estudo?page=1&perPage=100&sort=desc`, config);
...
const calculateProgress = (records, subjectId, version, targetTime) => {
    try {
        ...
        const filteredRecords = records.filter(record => (record.disciplinaId === subjectId || record.disciplinaId === String(subjectId)) &&
...
//# sourceMappingURL=cycleIntegration.js.map